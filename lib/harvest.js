...
module.exports = {
  ...
  getStartStatus: (id, opts = {}) => ezmesure.get(`/harvests-sessions/${id}/_start`, opts),
  stop: (id) => ezmesure.post(`/harvests-sessions/${id}/_stop`, undefined),
  getStopStatus: (id, opts = {}) => ezmesure.get(`/harvests-sessions/${id}/_stop`, opts),
